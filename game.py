...
class SpaceShooterGame:
    ...
    def start(self):  # This is now a method inside the class
        ...
        selected_character_index = selected_character.show_character_selection_menu(self.character_images_selection)
        
        player_image = pygame.transform.scale(self.character_images[selected_character_index], (80, 120))

        # Show difficulty selection
        index_difficulty = ShowMenu()
        difficulty = index_difficulty.show_difficulty_menu()
