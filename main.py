...
while waiting:                                              # Loop until the player decides to start the game
    ...
    drawText("Pressez ENTER pour lancer le jeu", font, windowSurface, windowSurface.get_width() // 2 - 200, windowSurface.get_height() // 2)  # Render the start message in the center of the screen
